...
def return_coordinates(
  ...
  for box, color in box_to_color_map.items():
    ...
    class_temp = category_index[classes[counter_for]]['name']
    score_temp = box_to_score_map[box]*100
    
    coordinates_list.append([class_temp, ymin, ymax, xmin, xmax, score_temp])
